---
name: prd-writer
description: Write a PRD for a feature or product — from speclet to full Solution Review doc. Adapts to the stage of the product decision.
...
Before generating anything, ask 2-3 clarifying questions. Tailor to what's missing. Common gaps:
